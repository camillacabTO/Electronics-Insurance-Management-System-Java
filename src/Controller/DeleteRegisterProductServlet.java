 ...
 */
@WebServlet("/DeleteRegisterProductServlet")
public class DeleteRegisterProductServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteRegisterProductServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(updateDao.deleteRegisteredProductDao(username, productname)) {
